...
func (app *App) routes() http.Handler {
	...
	// pages rangées derrière le menu, à propos, thème (pages.go)
	mux.HandleFunc("GET /e/{jeton}/reglages", app.pageReglages)
	mux.HandleFunc("GET /e/{jeton}/inviter", app.pageInviter)
	mux.HandleFunc("GET /a-propos", app.aPropos)
	mux.HandleFunc("POST /theme", app.choisirTheme)
